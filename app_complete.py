...
# --- FONCTION DE GÉNÉRATION PDF (Mise à jour avec Finance) ---
...
st.title("🌍 Cockpit de Performance Carbone & Financière")
st.markdown("Analysez le passé, simulez le futur, évaluez le risque financier et laissez l'IA segmenter les filiales.")
...
# --- 3. LE MODULE FINANCE (SIDEBAR) ---
st.sidebar.divider()
st.sidebar.header("💶 Risque Financier")
st.sidebar.info("Simulateur de Taxe Carbone (Shadow Carbon Pricing)")
...
# Affichage du coût dans la sidebar
st.sidebar.metric(
...
col4.metric("Impact Financier Global", f"{cout_total/1000:,.1f} k€", delta="Risque", delta_color="inverse")

st.divider()

# --- 6. LES 5 ONGLETS D'ANALYSE ---
